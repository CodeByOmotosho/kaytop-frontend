  ...
  return (
    <div className="bg-white rounded-xl shadow-md p-10 w-full mx-auto max-w-md md:max-w-xl mt-6">
      ...
      <div className="flex justify-between items-center mb-6">
        ...
        <Link href="/auth/customer/register" className="text-sm text-secondary hover:underline">
      ...
      {/* PASSWORD */}        
         <div className="flex items-center justify-between">
          ...
          Password
                ...
                <Link href="/auth/customer/forgot-password" className="text-sm text-primary hover:underline">
                  Forgot password?
                </Link>
              </div>
