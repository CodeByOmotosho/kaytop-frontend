  ...
  return (
    <div className="px-5 my-5">
      ...
      <div className="flex flex-col md:flex-row">
        <div>
          <h1 className="text-xl font-medium text-center md:text-3xl text-primary-500 md:text-left">
            Vision Statement
          </h1>
          <p className="my-2 tracking-wide text-neutral-500">
        ...
        <div>
          <h1 className="text-xl font-medium text-center md:text-3xl md:text-left text-primary-500">
            Mission Statement
          </h1>
          <p className="my-2 tracking-wide text-neutral-500">
